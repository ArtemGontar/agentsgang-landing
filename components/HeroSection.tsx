...
export default function HeroSection() {
  return (
    <section className="min-h-screen flex items-center bg-gradient-radial pt-20">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Column - Content */}
          <div className="lg:pr-8">
            <h1 className="text-hero font-bold text-gradient mb-6 leading-tight">
            ...
            <div className="flex items-center gap-3 text-text-secondary">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div 
                    key={i}
                    className="w-8 h-8 rounded-full bg-gradient-to-r from-primary-blue to-secondary-purple border-2 border-white flex items-center justify-center text-white text-xs font-semibold"
                  >
                    {i}
                  </div>
                ))}
          ...
          <div className="relative">
            <div className="relative z-10">
              ...
              <div className="bg-gradient-card rounded-2xl p-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border">
                    ...
                    <div className="text-xs font-semibold text-text-primary mb-2">ProtoHive Dashboard</div>
